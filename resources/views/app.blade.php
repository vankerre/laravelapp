...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="{{ URL::asset('assets/fonts-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="active">
                    <a href="{{url('articles')}}"><i class="fa fa-fw fa-dashboard"></i> Artigos</a>
                </li>
                <li>
